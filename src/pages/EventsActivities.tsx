  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium">المسابقات</CardTitle>
          </CardHeader>
          <CardContent>
          ...
          <div className="space-y-3">
            <div className="border rounded-lg p-4">
              <div className="flex items-start justify-between">
                ...
                <span className="text-xs bg-yellow-100 text-yellow-800 px-2 py-1 rounded">قريباً</span>
              </div>
            </div>
            <div className="border rounded-lg p-4">
              <div className="flex items-start justify-between">
                ...
                <span className="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">مفتوح</span>
              </div>
            </div>
          </div>
        </CardContent>
